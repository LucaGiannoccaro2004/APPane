...
let submit1 = document.getElementById("submitOrder1");
let submit2 = document.getElementById("submitOrder2");
...
function handleResponse(){
    ...
    if(this.response != "" && this.response != "[]"){
        ...
        for(let i=0; i<result.length; i++){
            ...
            document.getElementById("totale2").textContent = "Totale: " + totale + "€";
        }
    }else{
        submit2.style.display = "none";
        document.getElementById("totaleContainer").style.display = "none";
    ...
    submit2.addEventListener("click", ()=>{
            ...
            new Xhr("GET", "cart/list").makeRequest(function(){
                ...
                formData.append("e", "e");
                new Xhr("DELETE", "cart/delete").makeRequest(()=>{location.reload(); location.href = "./success.html";}, "application/json", formData);
