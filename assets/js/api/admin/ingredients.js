...
new Xhr("GET", "ingredients/list").makeRequest(handleResponse, "application/json", undefined); 
...
window.$("#addSubmit").click(function () {
    ...
    formData.append('api', "ingredients");
    formData.append("nome", String(document.getElementById("nomeAggiunta").value));
    formData.append("descrizione", String(document.getElementById("descrizioneAggiunta").value));
    new Xhr("POST", "ingredients/insert").makeRequest(function(){}, "application/json", formData);
    window.$("#overlay").hide();
	window.$("#addForm").hide();
    location.reload();
});
...
window.$("#modifySubmit").click(function () {
    ...
    formData.append("nome", String(document.getElementById("nomeModifica").value));
    formData.append("descrizione", String(document.getElementById("descrizioneModifica").value));
    formData.append("e", "e");
    new Xhr("PUT", "ingredients/update").makeRequest(function(){}, "application/json", formData);
    window.$("#overlay").hide();
	window.$("#modifyForm").hide();
    location.reload();
});
...
window.$("#deleteSubmit").click(function () {
    ...
    formData.append('id', id);
    formData.append("e", "e");
    new Xhr("DELETE", "ingredients/delete").makeRequest(function(){}, "application/json", formData);
    window.$("#overlay").hide();
